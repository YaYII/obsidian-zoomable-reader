  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        zh: "阅读视图图片/图表宽度",
        en: "Reading view image & diagram width",
        zhDesc: "默认「撑满版心」：图片与流程图（Mermaid/Excalidraw/charts）都按版心宽度等比缩放，高度自动，不裁剪不拉伸 —— 即使写了 ![[x.png|300]] 也统一到版心宽度。手机上于是永远一屏宽，细节交给双击放大。「不超过版心」只保证不溢出，「原始尺寸」完全交给主题。",
        enDesc: "Fill (default) scales images and diagrams (Mermaid, Excalidraw, charts) to the line width, keeping the aspect ratio — nothing is cropped or stretched, and explicit widths are normalised too. On a phone everything is one screen wide; double-tap for detail. Fit only prevents overflow; Natural leaves it to the theme.",
